...
[docs/features/installer-guide.md](../docs/features/installer-guide.md); for page flows
and implementation details see [docs/features/installer-flow.md](../docs/features/installer-flow.md).
...
[`docs/features/portable-single-file.md`](../docs/features/portable-single-file.md).
