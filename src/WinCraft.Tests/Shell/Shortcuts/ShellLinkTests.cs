...
namespace WinCraft.Tests.Shell.Shortcuts
{
    ...
    internal sealed class ShellLinkTests
    {
        ...
        public void IconLocation_Default_IsEmpty()
        {
            ...
            var location = link.IconLocation;

            Assert.That(location.FileName, Is.EqualTo(string.Empty));
            Assert.That(location.Index, Is.EqualTo(0));
        }
        ...
        public void IconLocation_SetAndGet_RoundTrips()
        {
            ...
            link.IconLocation = new IconLocation(@"C:\Windows\System32\shell32.dll", 42);

            var location = link.IconLocation;
            Assert.That(location.FileName, Is.EqualTo(@"C:\Windows\System32\shell32.dll"));
            Assert.That(location.Index, Is.EqualTo(42));
        }
