...
namespace WinCraft.Infrastructure.RegistryAccess
{
    ...
    internal sealed class RegistryPath(RegistryValueLocation location, string subKeyPath)
    {
        ...
        public static RegistryPath FromClassesRoot(string subKeyPath)
        {
        ...
        /// </summary>
        public RegistryPath Combine(string childPath)
        {
        ...
        /// <summary>
        /// Gets the parent registry path, or a root-level path if already at the hive root.
        /// </summary>
        ...
        /// <summary>
        /// Gets the leaf segment of this path.
        /// </summary>
        public string Name
        {
            get
